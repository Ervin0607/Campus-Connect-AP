...
public class LeftNavPanelStudent extends JPanel {
    ...
    public LeftNavPanelStudent(Theme CurrentTheme, String InitialActiveLabel) {
        this.CurrentTheme = CurrentTheme;
        this.ActiveLabel = (InitialActiveLabel == null) ? "Dashboard" : InitialActiveLabel;
        ...
        JLabel LogoLabel = new JLabel("Campus Connect");
        ...
        AddNavItem("Announcements");
        AddNavItem("Registrations");
        AddNavItem("Exams & Result");
        AddNavItem("Time Table");
